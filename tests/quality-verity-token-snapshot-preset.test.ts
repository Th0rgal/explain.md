...
describe("quality verity token snapshot preset", () => {
  it("produces deterministic quality metrics on a frozen real-Verity SimpleToken snapshot", async () => {
    const preset = resolveQualityBenchmarkPreset("fixture-verity-token-snapshot");
