...
describe("quality verity counter snapshot strict preset", () => {
  it("enforces strict entailment floor deterministically on the frozen snapshot corpus", async () => {
    const preset = resolveQualityBenchmarkPreset("fixture-verity-counter-snapshot-strict");
